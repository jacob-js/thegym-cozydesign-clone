...
function Hero() {
  return (
    <div className='bg-hero xl:h-[1024px] h-[1500px] lg:h-240 font-fauc overflow-y-hidden' >
        <div className="content-wrapper w-5/6 lg:w-full lg:px-6 mt-48 lg:mt-0 lg:flex justify-between items-center">
            <div className="w-full flex flex-col gap-5 pr-15 justify-center">
                <div className="text-choco.50 font-black text-[5rem] lg:text-22.5 leading-[1.1em] bg-trans bg-clip-text bg-choco.50 text-fill-transparent bg-12.5 py-2.5">Your design team for the cost of a salary.</div>
                <div className="font-semibold opacity-80 text-[39px] lg:text-4xl.3 text-light bg-trans bg-light bg-clip-text text-fill-transparent leading-[1.3em] py-2.5 mb-7.5 tracking-[0.4px]">

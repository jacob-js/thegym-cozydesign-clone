  ...
  return (
    <div className='py-35 px-6 bg-sdd relative'>
        ...
        <div className="content-wrapper">
            <div className="xl:max-w-[940px] mx-auto flex justify-center items-center">
                ...
                <div className="flex flex-col pl-25">
                    ...
                    <p className="text-light leading-[1.6em] mb-3.75 text-xl">Consider joining our <a href="https://sddd.org/" className="text-pink font-bold hover:underline">San Diego Design Designers</a> group. More than 700 people, we meet online via Slack and in person at social events around the city. It’s a great opportunity to share ideas, get inspired, find support, and celebrate great design.</p>
                </div>
            </div>
        </div>
    </div>

...
function Navbar() {
  ...
  return (
    <div className='bg-nav fixed w-full z-50'>
        <div className="flex justify-center lg:justify-between items-center ml-10 mr-6 gap-12 lg:gap-0">
            ...
            <div className="hidden lg:flex text-choco.10 font-fauc text-2xl.1 font-semibold">
                {
